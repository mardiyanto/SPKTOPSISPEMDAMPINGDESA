...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$handle = $pdo->prepare('INSERT INTO kriteria (nama, kode,type, bobot, urutan_order, ada_pilihan) VALUES (:nama, :kode, :type, :bobot, :urutan_order, :jenis_nilai)');
			...
			<?php endif; ?>			
				...
				<form action="tambah-kriteria.php" method="post">
					...
					<div class="field-wrap clearfix">					
						...
						<input class="form-control" type="text" name="kode" value="<?php echo $kode; ?>">
					</div>
					<div class="field-wrap clearfix">					
