...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$prepare_query = 'UPDATE kriteria SET nama = :nama, kode = :kode, type = :type, bobot = :bobot, urutan_order = :urutan_order, ada_pilihan = :jenis_nilai WHERE id_kriteria = :id_kriteria';
		$data = array(
			'nama' => $nama,
			'kode' => $kode,
			'type' => $type,
...
?>
 ...
 <div class="card">
                            ...
                            <div class="card-body">
                            <div class="header">
                                <h4 class="title">Edit Kriteria</h4>
			...
			<?php else: ?>				
				...
				<form action="edit-kriteria.php?id=<?php echo $id_kriteria; ?>" method="post">
					...
					<div class="field-wrap clearfix">					
						...
						<input class="form-control" type="number" name="bobot" value="<?php echo $bobot; ?>" step="0.01">
					</div>					
					<div class="field-wrap clearfix">					
						<label>Urutan</label>
						<input class="form-control" type="number" name="urutan_order" value="<?php echo $urutan_order; ?>">
					</div>
					<div class="field-wrap clearfix">					
						<label>Cara Penilaian</label>
						<select  class="form-control" name="jenis_nilai" id="jenis-nilai">
					...
					<div class="field-wrap clearfix">
						<button type="submit" name="submit" value="submit" class="btn btn-primary">Simpan Kriteria</button>
					</div>
				</form>
